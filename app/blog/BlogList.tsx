...
import { POSTS_COUNT_QUERY, POSTS_QUERY_FILTERED } from "@/sanity/lib/queries";
...
export default async function BlogList({
  ...
  // Fetch filtered count + paginated posts in parallel
  const [{ data: totalCount }, { data: posts }] = await Promise.all([
    sanityFetch({ query: POSTS_COUNT_QUERY, params: { category, search } }),
    sanityFetch({
