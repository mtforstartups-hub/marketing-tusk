                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <div>
                        <Link href="/" className="flex items-center space-x-2 mb-4 group">
                            <Image src="/images/logo-white.png" alt="Footer Logo" width={250} height={100} />
                        </Link>
                        <p className="text-gray-400 mb-6">
                            Your go-to ecosystem growth partner for startups, SMEs,
                            enablers, and investors across India.
                        </p>
